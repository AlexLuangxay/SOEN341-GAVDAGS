...
export const ServerHeader = ({ server, role }: ServerHeaderProps) => {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="z-50 w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-1 bg-white dark:bg-[#1e1f22] border border-neutral-200 dark:border-neutral-800 rounded-md shadow-lg">
