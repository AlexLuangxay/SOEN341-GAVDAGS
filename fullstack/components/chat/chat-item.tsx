...
import { ShieldCheck, ShieldAlert, FileIcon, Trash2, Edit, Trash } from "lucide-react";
...
const roleIconMap: Record<string, React.ReactNode> = {
  ...
  "ADMIN": <ShieldAlert className="h-4 w-4 ml-2 text-blue-500" />,
};
...
export const ChatItem = ({
  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
      <div className="group flex gap-x-2 items-start 2-full">
